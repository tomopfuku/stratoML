...
if __name__ == "__main__":
    ...
    for line in open(sys.argv[1],"r"):
        ...
        tree_utils.fix_obs_lv(tree) 
        ## THIS CALL IS JUST FOR TESTING AND WILL BE DELETED
        glc_bd.compute_glc_ASRs(tree, qmats, lam_mats, ss, bds_rates) 
        exit()
        ...
        lsub = p * subfrac
        qmats = qmat.Qmat(gainr, lossr)
        lam_mats.update_all_mats(p, lsub)

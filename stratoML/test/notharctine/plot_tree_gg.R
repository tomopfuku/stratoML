...
p=p+geom_rect(aes(xmin=Start,xmax=End,ymin=ymin,ymax=ymax),fill="grey")+theme_bw()+geom_text(aes(x=tab$text_pos_x,y=tab$text_pos_y),hjust=-0.01,label=tab$Name,size=5.2)
p=p+labs(x="ma",y="")

...
def parse_args(argv=None):
    ...
    parser.add_argument("--min-clado-fraction", type=float, default=0.2, help="Minimum simulated cladogenetic substitution fraction.")
    parser.add_argument("--max-clado-fraction", type=float, default=0.8, help="Maximum simulated cladogenetic substitution fraction.")
    parser.add_argument("--min-gain-rate", type=float, default=0.01, help="Minimum simulated gain rate.")
    parser.add_argument("--max-gain-rate", type=float, default=0.1, help="Maximum simulated gain rate.")

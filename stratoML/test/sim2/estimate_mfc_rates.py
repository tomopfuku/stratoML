...
if __name__ == "__main__":
    ...
    for fl in pathlist:
        ...
        qmats = qmat.Qmat(random()*.2,random()*.2)
        ...
        res_tr = minimize(mfc.evaluate_m_l2,x0=np.array([0.05,0.05]),args=(tree,qmats,ss),method="L-BFGS-B",bounds=((0.00001,0.5),(0.00001,0.5)))
        m = res_tr.x[0]
        f = res_tr.x[1]
